...
public class StorageHelperInitializer {
    public static final String[] PERMISSIONS = {
            ...
            "caesar.admin.sandbox.create",
            "caesar.admin.sandbox.assign",
            "caesar.admin.sandbox.activate",
            "caesar.admin.sandbox.deactivate",
            "caesar.admin.sandbox.delete",
            "caesar.admin.sandbox.sync",
            "caesar.sandbox.switch",
            "caesar.view.server",
